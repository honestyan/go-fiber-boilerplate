...
type User struct {
	...
	Gender   GenderEnum `boil:"gender" json:"gender" toml:"gender" yaml:"gender"`
...
type whereHelperGenderEnum struct{ field string }

func (w whereHelperGenderEnum) EQ(x GenderEnum) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperGenderEnum) NEQ(x GenderEnum) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperGenderEnum) LT(x GenderEnum) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperGenderEnum) LTE(x GenderEnum) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperGenderEnum) GT(x GenderEnum) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperGenderEnum) GTE(x GenderEnum) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperGenderEnum) IN(slice []GenderEnum) qm.QueryMod {
...
func (w whereHelperGenderEnum) NIN(slice []GenderEnum) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var UserWhere = struct {
	...
	Gender:   whereHelperGenderEnum{field: "\"users\".\"gender\""},
	Created:  whereHelpertime_Time{field: "\"users\".\"created\""},
	Modified: whereHelpertime_Time{field: "\"users\".\"modified\""},
}
...
var (
	userAllColumns            = []string{"id", "username", "password", "email", "name", "gender", "created", "modified"}
	userColumnsWithoutDefault = []string{"username", "password", "email", "name", "created"}
	userColumnsWithDefault    = []string{"id", "gender", "modified"}
